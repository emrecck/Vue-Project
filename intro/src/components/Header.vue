      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4 d-flex justify-content-center uye-islemleri">
            <router-link to="/signup" class="kayit text-decoration-none">
...
export default {
  ...
  computed: {
    ...
    total() {
      let temp = this.$store.state.itemList;
      let total = 0;
  ...
  methods: {
    ...
    filterCategory(){
      ...
      this.$store.commit("filterCategory",this.search)
    },
    // searchbox(){
