                ...
                <li class="nav-items col-sm-5 px-0">
                  <div class="urunadi d-flex">
                    ...
                    <div class="productName py-5 px-4">
                      <router-link  to="/product" class="name">
                        <span @click="addProductItem(product)">{{ product.name }} </span></router-link>
                    </div>
                  </div>
                </li>
...
export default {
  ...
  computed: {
    ...
    listSum(){
      let list = this.$store.state.itemList;
      let listSum =0;
      for(let i in list)
      {
  ...
  methods: {
    ...
    incCounter(index) {
      this.$store.commit("incCounter", index);
    },
    decCounter(index) {
      this.$store.commit("decCounter", index);
    },
